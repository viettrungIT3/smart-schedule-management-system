...
test_endpoint "POST" "/api/users" \
    "full_name=Test User $(date +%s)&email=testuser$(date +%s)@example.com&password=test123&role=student" \
    "200" "Create User API"

# Test schedule creation
test_endpoint "POST" "/api/schedules" \
    "subject_id=1&teacher_id=3&room_id=1&class_id=3&timeslot_id=2&weekday=3&schedule_date=2024-12-$(date +%d)&start_time=11:00&end_time=12:00" \
